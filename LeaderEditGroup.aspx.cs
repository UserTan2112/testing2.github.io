...
public partial class LeaderEditGroup : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>alert('" + "Something went wrong, maybe the Inventory have used this Group of tools " + "')</script>");
        }
    }
    ...
    protected void btnSelect_Click2(object sender, EventArgs e)
    {
