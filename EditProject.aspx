<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="EditProject.aspx.cs" Inherits="EditProject" %>
...
<div class="row">
         ...
         <div class="form-group">
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="text-danger" ErrorMessage="Please enter the Project Name" ForeColor="Red" ControlToValidate="txtUpdate"></asp:RequiredFieldValidator>
                    </div>
         
             <div class="form-group">
                        <label>Enter Project Manager:</label>
                        <asp:TextBox ID="txtPManager" CssClass="form-control" runat="server"  ></asp:TextBox> 
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="text-danger" ErrorMessage="Please enter the Project Manager" ForeColor="Red" ControlToValidate="txtPManager"></asp:RequiredFieldValidator>
                    </div>

             <div class="form-group">
                        <label>Enter ScenarioXiom:</label>
                        <asp:TextBox ID="txtScenarioXiom" CssClass="form-control" runat="server"  ></asp:TextBox> 
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="text-danger" ErrorMessage="Please enter the ScenarioXiom" ForeColor="Red" ControlToValidate="txtScenarioXiom"></asp:RequiredFieldValidator>
                    </div>

             <div class="form-group">
                                <label >Bill Of Materials</label>
                                <asp:DropDownList ID="ddlMaterials" runat="server" Class="form-control" Enabled="false" Height="34px" Width="100%">
                                </asp:DropDownList>
                            </div>
          ...
          <div class="form-group">
                        <asp:Button ID="btnUpdate" CssClass ="btn btn-primary " runat="server" 
                            Text="UPDATE" OnClick="btnUpdate_Click1"  />&emsp;<asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass ="btn btn-primary" OnClick="btnDelete_Click"  />
                    </div>
         </div>
