<%@ Page Title="" Language="C#" MasterPageFile="~/LeaderMasterPage.master" AutoEventWireup="true" CodeFile="LeaderAddProject3.aspx.cs" Inherits="LeaderAddProject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  background-repeat: no-repeat;
     ...
     <div class="container">
                 <div class="form-horizontal">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <asp:DropDownList ID="ddlBillOfMaterial" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                     </div>
                ...
                <div class="form-group">
                         <asp:Label ID="Label3" CssClass="col-md-2 control-label" runat="server" Text="Description"></asp:Label>
                        <div class="col-md-3">
                      ...
                      <div class="form-group">
                         <asp:Label ID="Label7" CssClass="col-md-2 control-label" runat="server" Text="User"></asp:Label>
                        <div class="col-md-3">
