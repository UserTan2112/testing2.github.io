<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="testing.aspx.cs" Inherits="testing" %>
                 ...
                 <div class="form-horizontal">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <asp:CheckBoxList ID="ckBillOfMaterial" runat="server" OnSelectedIndexChanged="ckBillOfMaterial_SelectedIndexChanged" AutoPostBack="true"></asp:CheckBoxList>
                        </div>
                          <div id="quantityContainer" class="col-md-3">
                            <asp:PlaceHolder ID="quantityPlaceHolder" runat="server"></asp:PlaceHolder>
                        </div>
                     </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".checkbox-list :checkbox").change(function () {
            var $container = $("#quantityContainer");
            $container.empty(); // Clear any existing textboxes

            // Loop through the checked checkboxes
            $(".checkbox-list :checkbox:checked").each(function () {
                var checkboxValue = $(this).val();

                // Create a textbox for each checked checkbox
                var $textbox = $("<input type='text' class='form-control quantity-input' />");
                $textbox.attr("id", "txtQuantity_" + checkboxValue);
                ...
                $container.append($textbox);
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:Button ID="btnAddProject" CssClass="btn btn-success" runat="server" Text="Add" OnClick="btnAddProject_Click" />
